...
const torat = [
    ...
    {title:"تورتة فروت شيري",price:"440",img:""},
    ...
    {title:"تورتة ملفاي شوكلت",price:"495",img:""},
...
const dessert_pieces = [
    ...
    {title:"تشيز بارد",price:"300",img:"تشيز بارد.webp"},
...
async function DisplayCategory (category) {
    ...
    var food = '';
    await category.forEach(function (item) {
        food += `
            <div class="card col-md-4 col-sm-6 col-lg-3 border-0 bg-transparent ${item.second_title}">
                <div class ="card-image">
                    <img src="${item.img}" class="card-img img-fluid">
                </div>
                <div class="card-img-overlay text-white d-flex text-center justify-content-center flex-column">
                    <h3 class="card-title fs-1">${item.title}</h3>
                </div>
            </div>
        `;
...
async function  Displayitems (category) {
    ...
    await category.forEach(function (item) {
        food += `
            <div class="card card-item col-md-4 col-sm-6 col-lg-3 border-0 bg-transparent ">
                <div class ="card-image">
                    <img src="${item.img}" class="card-img img-fluid">
                </div>
                <div class="card-img-overlay text-white d-flex text-center justify-content-center flex-column">
                    <h3 class="card-title fs-1 fw-bolder">${item.title}</h3>
                    <p class="card-text"><small>${item.price} EGP</small></p>
                </div>
            </div>
        `;
        categories.innerHTML = food;
...
// display sub categories on click  it's name
